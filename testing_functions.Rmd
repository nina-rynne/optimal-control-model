...
combined_default <- add_fixed_parameters(default_samples)
cat("\nStructure of the returned dataframe:\n")
str(combined_default)
cat("\nColumn names in the combined dataframe:\n")
cat(paste(names(combined_default), collapse = ", "), "\n")
